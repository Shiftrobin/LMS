...
//User dashboard guard middleware
...
Route::middleware('auth')->group(function () {
    ...
    Route::post('/user/password/update', action: [UserController::class, 'UserPasswordUpdate'])->name('user.password.update');
...
Route::middleware(['auth','roles:instructor'])->group(function () {
    ...
    Route::controller(CourseController::class)->group(function(){
        ...
        Route::post('/update/courese/lecture','UpdateCourseLecture')->name('update.course.lecture');
...
Route::controller(QuizController::class)->group(function(){
    ...
    Route::post('/update/quiz','UpdateQuiz')->name('update.quiz');
    Route::get('/delete/quiz/{id}','DeleteQuiz')->name('delete.quiz');

    // user quiz view
    Route::get('/quizdesk/view/{instructorId}/{courseId}/{sectionId}/{lectureId}', 'QuizDeskView');
    Route::post('/quizresult/store', 'QuizResultStore')->name('quizresult.store');
    Route::get('/quizresult/thank-you','QuizResultThankYou')->name('quizresult.thankyou');
});
