<template>
          ...
          <!-- my part  -->
              <li class="buyer clearfix" v-else>
                <span class="chat-img right clearfix mx-2">
                  <img :src="'http://localhost/learning/easylearningbd/lms/public/upload/user_images/'+msg.user.photo"
                    class="userImg"
                    alt="userImg"
                  />
                   </span>
  ...
  export default {
    ...
    methods:{
      ...
      userMessage(userId){
        axios.get('http://localhost/learning/easylearningbd/lms/user-message/'+userId)
        .then((res) => {
