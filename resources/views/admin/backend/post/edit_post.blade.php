...
<div class="page-content">
    ...
    <div class="card">
        <div class="card-body p-4">
            ...
            <form action="{{ route('update.blog.post') }}" method="POST" class="row g-3" id="myForm" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" name="post_title" id="input1" value="{{ $post->post_title }}">
                </div>
                <div class="form-group col-md-12">
                    <label for="input1" class="form-label">Post Description</label>
                    <textarea name="long_descp" id="myeditorinstance">{!! $post->long_descp !!}</textarea>
                </div>
                <div class="form-group col-md-6">
                ...
                <div class="col-md-6">
                    <img id="showImage" src="{{ asset('public/'.$post->post_image) }}" alt="blog" class="rounded-circle p-1 bg-primary" width="80">
                </div>
