...
<div class="page-content">
    ...
    <div class="card">
        <div class="card-body p-4">
            <h5 class="mb-4">
                Edit Role In Permission</h5>

            <form action="{{ route('admin.roles.update', $role->id) }}" method="POST" class="row g-3" id="myForm">
                @csrf
                ...
                @foreach ($permission_groups as $group )
                    ...
                    <div class="row">
                        <div class="col-3">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault" {{ App\Models\User::roleHasPermissions($role,$permissions)
                                ? 'checked' : '' }}>
