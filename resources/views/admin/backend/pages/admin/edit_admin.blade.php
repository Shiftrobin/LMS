        ...
        <div class="card-body p-4">
            ...
            <form action="{{ route('update.admin',$user->id) }}" method="POST" class="row g-3" id="myForm">
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" name="username" id="input1" value="{{ $user->username }}">
                </div>
                <div class="form-group col-md-6">
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="email" class="form-control" name="email" id="input1" value="{{ $user->email }}">
                </div>
                <div class="form-group col-md-6">
                    <label for="input1" class="form-label">Admin Phone </label>
                    <input type="text" class="form-control" name="phone" id="input1" value="{{ $user->phone }}">
                </div>
                <div class="form-group col-md-6">
                    <label for="input1" class="form-label">Admin Address</label>
                    <input type="text" class="form-control" name="address" id="input1" value="{{ $user->address }}">
                </div>
