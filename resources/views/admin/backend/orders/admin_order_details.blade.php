                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                       @if ($payment->status == 'pending')
                                        <a href="{{ route('pending-confirm', $payment->id) }}" class="btn btn-block btn-danger" id="confirm">Confirm Order</a>
                                ...
                                <table class="table" style="font-weight: 600;">
                                    <tbody>
                                        ...
                                        @foreach ($orderItem as $item )
                                            <tr>
                                                <td class="col-md-1">
                                                    <label><img src="{{ asset('public/'.$item->course->course_image) }}" alt="" style="width: 50px; height:50px;"> </label>
                                                </td>
                                                <td class="col-md-2">
