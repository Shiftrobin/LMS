    ...
    <div class="chat-wrapper">
            ...
            <div class="chat-sidebar-header">
                <div class="d-flex align-items-center">
                    <div class="chat-user-online">
                        <img src="{{ (!empty($profileData->photo)) ? url('public/upload/instructor_images/'.$profileData->photo) : url('public/upload/no_image.jpg') }}" width="45" height="45" class="rounded-circle" alt="" />
                    </div>
                        ...
                        <div class="chat-list pt-3">
                            <div class="list-group list-group-flush">
                                ...
                                <a href="javascript:;" class="list-group-item">
                                    <div class="d-flex">
                                        <div class="chat-user-online">
                                            <img src="{{ (!empty($question->user->photo)) ? url('public/upload/user_images/'.$question->user->photo) : url('public/upload/no_image.jpg') }}" width="42" height="42" class="rounded-circle" alt="" />
                                        </div>
                                        <div class="flex-grow-1 ms-2">
        ...
        <div class="chat-content">
            <div class="chat-content-leftside">
                <div class="d-flex">
                    <img src="{{ (!empty($question->user->photo)) ? url('public/upload/user_images/'.$question->user->photo) : url('public/upload/no_image.jpg') }}" width="48" height="48" class="rounded-circle" alt="" />
                    <div class="flex-grow-1 ms-2">
