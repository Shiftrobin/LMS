...
<div class="page-content">
    ...
    <div class="card">
        <div class="card-body p-4">
            ...
            <form action="{{ route('store.course') }}" method="POST" class="row g-3" id="myForm" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" name="course_title" id="input1">
                </div>
                ...
                <div class="form-group col-md-6">
                    <label for="input1" class="form-label">Course Into video</label>
                ...
                <div class="form-group col-md-3">
                    ...
                    <input type="text" class="form-control" name="selling_price" id="input1">
                </div>

                <div class="form-group col-md-3">
                    <label for="input1" class="form-label">Discount Price</label>
                    <input type="text" class="form-control" name="discount_price" id="input1">
                </div>

                <div class="form-group col-md-3">
                    <label for="input1" class="form-label">Duration </label>
                    <input type="text" class="form-control" name="duration" id="input1">
                </div>

                <div class="form-group col-md-3">
                    <label for="input1" class="form-label">Resources</label>
                    <input type="text" class="form-control" name="resources" id="input1">
                </div>

                <div class="form-group col-md-12">
                    <label for="input1" class="form-label">Course Prerequisites</label>
                    <textarea name="prerequisites" id="input11" class="form-control" rows="3"></textarea>
                </div>
