  ...
  <table width="100%" style="background: #F7F7F7; padding:0 20px 0 20px;">
    <tr>
        <td valign="top">
          ...
          <h2 style="color: green; font-size: 26px;"><strong>AIMS Education</strong></h2>
        </td>
        <td align="right">
            <pre class="font" >
               AIMS Education<br>
               Email:support@aimseducation.co.uk<br>
               Mob: 1245454545 <br>
               Dhaka, Bangladesh <br>
...
<h3>Products</h3>
  ...
  <table width="100%" style=" padding:0 10px 0 10px;">
    <tr>
        <td align="right" >
            <h2><span style="color: green;">Subtotal:</span> {{ $item->payment->total_amount }} tk</h2>
            <h2><span style="color: green;">Total:</span> {{ $item->payment->total_amount }} tk</h2>
