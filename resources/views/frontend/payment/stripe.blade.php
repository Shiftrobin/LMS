                            ...
                            @foreach ($carts as $item)
                                ...
                                <div class="media media-card border-bottom border-bottom-gray pb-3 mb-3">
                                    <a href="{{ url('course/details/'.$item->id.'/'.$item->options->slug) }}" class="media-img">
                                        <img src="{{ asset('public/'.$item->options->image) }}" alt="Cart image">
                                    </a>
...
var stripe = Stripe('pk_test_51QxQN5HXG6g7zT9MhXe6r96LKjwukjSmiMAONdsP3zh8ZMOMME5GRpUgGJ2aJ3PGgFWjmBzslpmi4YPFc0ZtTXCV000DXtBhxV');
