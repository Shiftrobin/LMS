...
<head>
    ...
    <!-- Favicon -->
    <link rel="icon" sizes="16x16" href="{{ asset('public/frontend/images/favicon.png') }}">
...
<script src="{{ asset('public/frontend/js/doughnut-chart.js') }}"></script>
<script src="{{ asset('public/frontend/js/bar-chart.js') }}"></script>
<script src="{{ asset('public/frontend/js/line-chart.js') }}"></script>
...
<script src="{{ asset('public/frontend/js/animated-skills.js') }}"></script>
<script src="{{ asset('public/frontend/js/jquery.MultiFile.min.js') }}"></script>
