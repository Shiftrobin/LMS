                        ...
                        <form method="POST" action="{{ route('register') }}" class="pt-4">
                            ...
                            <div class="btn-box">
                                <div class="custom-control custom-checkbox mb-2 fs-15">
                                    ...
                                    <label class="custom-control-label custom--control-label lh-20" for="receiveCheckbox">Yes! I want to receive emails with exclusive deals, personal recommendations and learning tips!</label>
