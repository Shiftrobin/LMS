...
<div class="breadcrumb-content d-flex flex-wrap align-items-center justify-content-between mb-5">
    <div class="media media-card align-items-center">
        <div class="media-img media--img media-img-md rounded-full">
            <img class="rounded-full" src="{{ (!empty($profileData->photo)) ? url('public/upload/user_images/'.$profileData->photo) : url('public/upload/no_image.jpg') }}" alt="Student thumbnail image">
        </div>
...
<div class="tab-pane fade show active mb-5" id="edit-profile" role="tabpanel" aria-labelledby="edit-profile-tab">
    <div class="setting-body">
        ...
        <div class="media media-card align-items-center">
            <div class="media-img media-img-lg mr-4 bg-gray">
                <img class="mr-3" src="{{ (!empty($profileData->photo)) ? url('public/upload/user_images/'.$profileData->photo) : url('public/upload/no_image.jpg') }}" alt="avatar image">
            </div>
            <div class="media-body">
