            ...
            <div class="container">
                <div class="hero-content">
                    <div class="section-heading">
                        <h1 class="section__title text-white fs-35 lh-35 pb-3">AIMS Education</h1>
                        <p class="section__desc text-white pb-4">We Help You Learn What You Love
                        </p>
        ...
        <div class="hero-slider-item hero-bg-2">
            <div class="container">
                <div class="hero-content text-center">
                    <div class="section-heading">
                        <h2 class="section__title text-white fs-35 lh-35 pb-3">Join with us</h2>
                        <p class="section__desc text-white pb-4"> Get your desired course
                        </p>
                    </div><!-- end section-heading -->
        ...
        <div class="hero-slider-item hero-bg-3">
            <div class="container">
                <div class="hero-content text-right">
                    <div class="section-heading">
                        <h2 class="section__title text-white fs-35 lh-35 pb-3">Learn Anything</h2>
                        <p class="section__desc text-white pb-4">Anytime, Anywhere
                        </p>
                    </div>
