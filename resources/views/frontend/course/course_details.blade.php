...
@section('title')
{{ $course->course_name }} | AIMS Education
@endsection
        ...
        <div class="row">
           <div class="col-lg-8 pb-5">
               <div class="course-details-content-wrap pt-90px">
                   ...
                   <div class="course-overview-card">
                    ...
                    <div class="course-overview-card border border-gray p-4 rounded">
                       <h3 class="fs-20 font-weight-semi-bold">Top companies trust AIMS</h3>
                       <p class="fs-15 pb-1">Get your team access to Aduca's top 5,000+ courses</p>
                        <div class="pb-3">
                            <img width="85" class="mr-3" src="{{ asset('public/frontend/images/sponsor-img.png') }}" alt="company logo">
                            <img width="80" class="mr-3" src="{{ asset('public/frontend/images/sponsor-img2.png') }}" alt="company logo">
                            <img width="80" class="mr-3" src="{{ asset('public/frontend/images/sponsor-img3.png') }}" alt="company logo">
                            <img width="70" class="mr-3" src="{{ asset('public/frontend/images/sponsor-img4.png') }}" alt="company logo">
                        </div>
                            ...
                            @foreach ($section as $sec )
                               ...
                               <div class="card">
                                   <div class="card-header" id="heading{{ $sec->id }}">
                                       <button class="btn btn-link d-flex align-items-center justify-content-between" data-toggle="collapse"
                                       data-target="#collapse{{ $sec->id }}" aria-expanded="true" aria-controls="collapse{{ $sec->id }}">
                                   ...
                                   <div id="collapse{{ $sec->id }}"
                                        class="collapse" aria-labelledby="heading{{ $sec->id }}" data-parent="#accordion">
                                       <div class="card-body">
                           ...
                           <div class="media media-card">
                               <div class="instructor-img">
                                   <a href="teacher-detail.html" class="media-img d-block">
                                       <img class="lazy" src="{{ (!empty($course->user->photo)) ? url('public/upload/instructor_images/'.$course->user->photo) : url('public/upload/no_image.jpg') }}" data-src="{{ (!empty($course->user->photo)) ? url('public/upload/instructor_images/'.$course->user->photo) : url('public/upload/no_image.jpg') }}" alt="Avatar image">
                                   </a>
                        ...
                        @foreach ($reviews as $item )
                           ...
                           <div class="media media-card border-bottom border-bottom-gray pb-4 mb-4">
                               <div class="media-img mr-4 rounded-full">
                                   <img class="rounded-full lazy" src="{{ (!empty($item->user->photo)) ? url('public/upload/user_images/'.$item->user->photo) : url('public/upload/no_image.jpg') }}" data-src="{{ (!empty($item->user->photo)) ? url('public/upload/user_images/'.$item->user->photo) : url('public/upload/no_image.jpg') }}" alt="User image">
                               </div>
                               <div class="media-body">
                        ...
                        <div class="card-body">
                            <div class="preview-course-video">
                                <a href="javascript:void(0)" data-toggle="modal" data-target="#previewModal">
                                    <img src="{{ asset('public/') }}images/img-loading.png" data-src="{{ asset('public/'.$course->course_image) }}" alt="course-img" class="w-100 rounded lazy">
                            ...
                            <div class="preview-course-feature-content pt-40px">
                                <p class="d-flex align-items-center pb-2">
                                    ...
                                    @else
                                        <span class="fs-35 font-weight-semi-bold text-black">${{ $course->selling_price }}</span>
                                        <span class="before-price mx-1">${{ $course->discount_price }}</span>
                                    @endif
            ...
            <div class="buy-course-btn-box">
                ...
                <i class="la la-shopping-cart fs-18 mr-1"></i> Add to cart</button>
                ...
                <button type="button" class="btn theme-btn w-100 theme-btn-white mb-2"
                 onclick="buyCourse('{{ $course->id }}','{{ $course->course_name }}','{{ $course->instructor_id }}','{{ $course->course_name_slug }}')">
                    <i class="la la-shopping-bag mr-1"></i> Buy this course</button>
                  ...
                  <a type="submit" onclick="applyInsCoupon()" class="btn theme-btn text-white">Apply Code</a>
                                ...
                                <div class="preview-course-incentives">
                                    ...
                                    <ul class="generic-list-item pb-3">
                                        ...
                                        <li><i class="la la-file mr-2 text-color"></i>{{ $course->duration }} articles</li>
                            ...
                            @foreach ($relatedCourses as $related)
                                ...
                                <div class="media media-card border-bottom border-bottom-gray pb-4 mb-4">
                                    <a href="course-details.html" class="media-img">
                                        <img class="mr-3 lazy" src="{{ asset('public/'.$related->course_image) }}" data-src="{{ asset('public/'.$related->course_image) }}" alt="Related course image">
                                    </a>
                                    <div class="media-body">
                ...
                <div class="card card-item">
                    <div class="card-image">
                        <a href="{{ url('course/details/'.$inscourse->id.'/'.$inscourse->course_name_slug) }}" class="d-block">
                            <img class="card-img-top" src="{{ asset('public/'.$inscourse->course_image) }}" alt="Card image cap">
                        </a>
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            @else
                                <p class="card-price text-black font-weight-bold">${{ $inscourse->selling_price }}
                                    <span class="before-price font-weight-medium">{{ $inscourse->discount_price }}</span>
                                </p>
                            @endif
            ...
            <div class="modal-body">
                <div class="copy-to-clipboard">
                    ...
                    <div class="input-group">
                        <input type="text" class="form-control form--control copy-input pl-3" value="{{ url('/') }}/{{ Request::path() }}">
                        <div class="input-group-append">
...
<div class="modal fade modal-container" id="previewModal" tabindex="-1" role="dialog" aria-labelledby="previewModalTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <video controls crossorigin playsinline poster="{{ asset('public/'.$course->course_image) }}" id="player">
                    <!-- Video files -->
