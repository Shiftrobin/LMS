...
@section('home')
@section('title')
{{ $instructor->name }} | AIMS Education
@endsection
        ...
        <div class="breadcrumb-content">
            <div class="media media-card align-items-center pb-4">
                <div class="media-img media--img media-img-md rounded-full">
                    <img class="rounded-full" src="{{ (!empty($instructor->photo)) ? url('public/upload/instructor_images/'.$instructor->photo) : url('public/upload/no_image.jpg') }}" alt="Student thumbnail image">
                </div>
    ...
    <div class="bg-gray py-5">
        <div class="container">
            <ul class="nav nav-tabs generic-tab justify-content-center" id="myTab" role="tablist">
                ...
                @else
                    <button class="btn theme-btn d-none d-lg-inline-block">For Chat Login First</button>
                @endauth
