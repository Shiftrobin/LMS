                        ...
                        <form method="POST" action="{{ route('instructor.register') }}" class="row">
                            ...
                            <div class="input-box col-lg-6">
                                ...
                                <div class="form-group">
                                    <input class="form-control form--control @error('name') is-invalid
                                                @enderror" type="text" name="name" placeholder="Enter you name">
                            ...
                            <div class="input-box col-lg-6">
                                ...
                                <div class="form-group">
                                    ...
                                    @enderror" type="text" name="username" placeholder="Enter User Name">
                                    <span class="la la-user input-icon"></span>
                                    @error('username')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                            ...
                            <div class="input-box col-lg-6">
                                ...
                                <div class="form-group">
                                    ...
                                    @enderror" type="email" name="email" placeholder="Enter you email address">
                            ...
                            <div class="input-box col-lg-6">
                                ...
                                <div class="form-group">
                                    <input id="phone" class="form-control form--control  @error('phone') is-invalid
                            ...
                            <div class="input-box col-lg-12">
                                ...
                                <div class="form-group">
                                    ...
                                    @enderror" type="text" name="address" placeholder="e.g. 12345 Little Baker St, Melbourne">
