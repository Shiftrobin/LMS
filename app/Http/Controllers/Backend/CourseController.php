...
class CourseController extends Controller
{
    ...
    public function SaveLecture(Request $request)
    {
       //Validate input
        ...
        if ($request->hasFile('video')) {
            $video = $request->file('video');
            $videoName = uniqid('lecture_', true) . '.' . $video->getClientOriginalExtension();
            $video->move(public_path('upload/course/lecture-video/'), $videoName);
            $videoPath = 'upload/course/lecture-video/' . $videoName;
        }
        ...
        $lecture->content = $request->content ?? null;
    ...
    public function DeleteLecture($id){
       ...
       unlink('public/'.$course_lecture->video);
       CourseLecture::find($id)->delete();

       $quizData = Quiz::where('lecture_id', $id)->get();
       ...
       foreach($quizData as $item){
           ...
           $item->d;
           $item->ans;
           Quiz::where('lecture_id', $id)->delete();
       }

       $quizResultData = QuizResult::where('lecture_id', $id)->get();

       foreach($quizResultData as $item){
           $item->result;
           QuizResult::where('lecture_id', $id)->delete();
       }
